...
const navigation = [
  ...
  { name: 'Transactions', href: '/transactions', roles: ['admin', 'operator', 'viewer'] },
  { name: 'NACHA Files', href: '/nacha-files', roles: ['admin', 'operator', 'viewer'] },
  { name: 'Reports', href: '/reports', roles: ['admin', 'operator', 'viewer'] },
  { name: 'Configuration', href: '/config', roles: ['admin'] },
];
